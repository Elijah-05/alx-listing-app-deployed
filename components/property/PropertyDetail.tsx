...
const PropertyDetail: React.FC<{ property: PropertyProps }> = ({
  ...
  return (
    <div className="max-w-[1500px] mx-auto p-6">
      ...
      {/* Image Grid */}
      <div className="relative grid grid-cols-4 grid-rows-[150px_150px] md:grid-rows-[200px_200px] xl:grid-rows-[300px_300px] gap-4 mt-4 rounded-[22px] overflow-hidden">
      ...
      {/* Amenities */}
      {/* Reviews and Booking */}
      <div className="w-full mt-8 flex flex-col-reverse xl:flex-row gap-8">
        <div className="grow">
